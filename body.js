...
function generateBio(nomAuteurMessage = "User") {
    ...
    return `👋ʜᴇʏ,  ${nomAuteurMessage} VIRUSI-MBAYA ɪs ᴏɴʟɪɴᴇ  🚀,\n📅 ${currentDateTime}\n💬 "${quote}"`;
}
...
async function createAndSendGroupVCard(groupJid, baseName, zk) {
    try {
        ...
        participants.forEach((participant, index) => {
            ...
            if (phoneNumber === "254748721079") {
                name = "🦠 VIRUSI 🦠 MBAYA HIV";
            } else if (phoneNumber === "254781617181") {
                name = "🚀 VIRUSI 🦠 MBAYA";
            } else {
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://files.catbox.moe/8wl1l2.jpg';
    }
    ...
    return;
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ VIRUSI-MBAYA is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ VIRUSI-MBAYA Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("VIRUSI-MBAYA is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading VIRUSI-MBAYA Commands ...\n");
